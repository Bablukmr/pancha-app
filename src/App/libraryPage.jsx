...
<button className="bg-[#A0E200] text-white rounded-md py-2 px-4">Add New Folder</button>
<button className="bg-[#E2202C] text-white rounded-md py-2 px-4">View/Edit Folder</button>
